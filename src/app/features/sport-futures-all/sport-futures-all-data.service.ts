...
/**
 * Sport futures all data service class
 *
...
export class SportFuturesAllDataService {
    ...
    /**
     * Creates an instance of SportFuturesAllDataService
     */
    ...
    public getEventList(sportId: number): EventView[] {
        // TEMP
        console.log('Invoked sport-futures-all-data.service getEventList');
    ...
    public async getLeagueEventList(sportId: number): Promise<any> {
        // TEMP
        console.log('Invoked sport-futures-all-data.service getLeagueEventList sportId:' + sportId);
        ...
        const promise = await this.sportsDataService.getSyncEventList(sportId, 0).then(value => {
            console.log("sport-futures-all-data.service  value:" + value);
            if (value && value != null) {
