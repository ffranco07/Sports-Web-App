...
import { SportLeagueAllDataService } from 'src/app/features/sport-league-all/sport-league-all-data.service';
...
export class SportLeagueAllComponent implements OnInit {
  // Router subscription
  ...
  constructor(
    ...
    private sportLeagueAllService: SportLeagueAllDataService) { }
  ...
  */
  private async fetchData() {
    ...
    const promise = await this.sportLeagueAllService.getLeagueEventList(routeState.data.sport.id).then(value => {
