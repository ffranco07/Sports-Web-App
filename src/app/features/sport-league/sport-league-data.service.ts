...
export class SportLeagueDataService {
     ...
     * @returns Promise<any>
     */
    public async getLeagueEventList(sportId: number, setId: number): Promise<any> {
        // TEMP
        ...
        const promise = await this.sportsDataService.getSyncEventList(sportId, setId).then(value => {
